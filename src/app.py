...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for school matches and tournaments",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Practice and play recreational soccer with teammates",
    ...
    "Robotics Club": {
        "description": "Build and program robots for engineering challenges and competitions",
...
@app.delete("/activities/{activity_name}/participant/{email}/unregister")
